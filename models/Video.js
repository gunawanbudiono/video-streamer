...
class Video {
  ...
  static findAll(userId = null) {
    return new Promise((resolve, reject) => {
      const query = userId ?
        'SELECT * FROM videos WHERE user_id = ? ORDER BY rowid DESC' :
        'SELECT * FROM videos ORDER BY rowid DESC';
  ...
  static findByUserAndFolder(userId, folderId = null) {
    return new Promise((resolve, reject) => {
      ...
      const query = isRoot
        ? 'SELECT * FROM videos WHERE user_id = ? AND folder_id IS NULL ORDER BY rowid DESC'
        : 'SELECT * FROM videos WHERE user_id = ? AND folder_id = ? ORDER BY rowid DESC';
